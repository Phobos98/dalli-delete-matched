# This is a dupe of the memcached mock found in Dali.
# TODO find a better way to include this instead of duplicating it from https://github.com/mperham/dalli/blob/master/test/memcached_mock.rb
require "socket"
